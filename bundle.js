...
function (_React$Component) {
  ...
  _createClass(AutoComplete, [{
    ...
    value: function componentDidMount() {
      ...
      document.getElementsByName('autocomplete-input')[0].addEventListener('input', function (e) {
    ...
    value: function handleInput(e) {
      if (e.data === null) {
        this.setState({
          inputVal: this.state.inputVal.slice(1)
        });
        console.log(this.state.inputVal);
      } else {
        this.setState({
          inputVal: this.state.inputVal += e.data
        });
        console.log(this.state.inputVal);
      }
    }
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, names.map(function (name, idx) {
        if (name.includes(_this3.state.inputVal)) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "clock"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "Clock"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "Hours: ", date.getHours() % 12), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "Minutes: ", date.getMinutes()), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "Seconds: ", date.getSeconds()))));
    }
  }]);
...
function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, content[this.state.currentTab].content)));
    }
  }]);
  ...
  _createClass(Weather, [{
    ...
    value: function componentDidMount() {
      ...
      navigator.geolocation.getCurrentPosition(function (position) {
        _this2.handleWeather(position);
      }); // this.getWeather().then(() => console.log('promise!'));
    }
  }, {
    key: "handleWeather",
    value: function handleWeather(pos) {
      var _this3 = this;

      this.getWeather(pos).then(function (data) {
        return _this3.setLocation(data);
      });
    }
  }, {
    key: "setLocation",
    ...
    value: function getWeather(pos) {
      ...
      return $.ajax({
        type: 'GET',
        url: 'http://api.openweathermap.org/data/2.5/weather' + "?lat=".concat(lat, "&lon=").concat(long, "&appid=4933d7f3ea2430f18606b323bcbbd7f0"),
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "weather"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "Weather"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, weather.location), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, weather.type), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, weather.description)));
    }
  }]);
...
/* harmony import */ var _autocomplete__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./autocomplete */ "./frontend/autocomplete.jsx");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  _createClass(Widgets, [{
    key: "render",
    value: function render() {
      var names = ['tyler', 'logan', 'quinn', 'lynn', 'tim', 'tom', 'ginna', 'katie'];
      var tabs = [{
        title: 'One',
        content: 'First tab'
      }, {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_clock__WEBPACK_IMPORTED_MODULE_1__["default"], null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_tabs__WEBPACK_IMPORTED_MODULE_2__["default"], {
        content: tabs
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_weather__WEBPACK_IMPORTED_MODULE_3__["default"], null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_autocomplete__WEBPACK_IMPORTED_MODULE_4__["default"], {
        names: names
      }));
    }
  }]);
